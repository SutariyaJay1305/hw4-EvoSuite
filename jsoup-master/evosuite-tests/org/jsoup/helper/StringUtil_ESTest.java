...
public class StringUtil_ESTest extends StringUtil_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      CharBuffer charBuffer0 = CharBuffer.allocate(1481);
      StringBuilder stringBuilder1 = stringBuilder0.append((CharSequence) charBuffer0, 0, 1481);
      StringBuilder stringBuilder2 = stringBuilder0.append((CharSequence) stringBuilder1, 0, 690);
      stringBuilder1.append((-130.67F));
      stringBuilder1.appendCodePoint(1481);
      StringBuilder stringBuilder3 = stringBuilder1.append((CharSequence) charBuffer0);
      StringBuilder stringBuilder4 = stringBuilder1.insert(1481, "width must be >c0");
      StringBuilder stringBuilder5 = stringBuilder2.append((Object) "width must be >c0");
      stringBuilder5.append((Object) stringBuilder4);
      StringBuilder stringBuilder6 = StringUtil.stringBuilder();
  ...
  public void test02()  throws Throwable  {
      URL uRL0 = MockURL.getHttpExample();
      URL uRL1 = StringUtil.resolve(uRL0, "?P;kHZ{<w D4y.*m@");
      assertEquals("http://www.someFakeButWellFormedURL.org/fooExample?P;kHZ{<w D4y.*m@", uRL1.toString());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("B.]yw|t~d`X*FnA_", "", 0, ")CR$;Q0\"*usS%-RxU23", uRLStreamHandler0);
      try { 
        StringUtil.resolve(uRL0, ".!{]5u9L>~;f;tMH7");
        fail("Expecting exception: MalformedURLException");
      
      } catch(MalformedURLException e) {
         //
         // unknown protocol: b.]yw|t~d`x*fna_
         //
  ...
  public void test27()  throws Throwable  {
      String[] stringArray0 = new String[9];
      boolean boolean0 = StringUtil.isNumeric(stringArray0[3]);
      assertFalse(boolean0);
  }
  ...
  public void test32()  throws Throwable  {
      String string0 = StringUtil.padding(1978);
